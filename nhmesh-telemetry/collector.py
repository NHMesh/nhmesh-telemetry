...
def parse_standard_meshtastic_packet(raw_packet_dict):
    ...
    try:
        ...
        parsed_data = {
            ...
            "altitude": position_part.get("altitude"),
            "latitude": lat, "longitude": lon,
            "precision_bits": position_part.get("precisionBits"), 
            ...
            "user_hardware_model_id": user_part.get("hwModel"), 
            "user_long_name": user_part.get("longName"),
            "user_role": user_part.get("role"), 
            "user_short_name": user_part.get("shortName"),
